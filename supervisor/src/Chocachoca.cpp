...
{
    ::std::pair< const ::std::string*, const ::std::string*> r = ::std::equal_range(__RoboCompChocachoca__Chocachoca_all, __RoboCompChocachoca__Chocachoca_all + 8, current.operation);
    if(r.first == r.second)
    {
