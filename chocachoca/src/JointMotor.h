...
class JointMotorPublish;
bool operator==(const JointMotorPublish&, const JointMotorPublish&);
bool operator<(const JointMotorPublish&, const JointMotorPublish&);
...
public:
    ...
    void motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap)
    {
        motorStates(mstateMap, 0);
    }
    void motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::Ice::Context& __ctx)
    {
        motorStates(mstateMap, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_motorStates(mstateMap, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_motorStates(mstateMap, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_motorStates(mstateMap, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_motorStates(mstateMap, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap)
    {
        return begin_motorStates(mstateMap, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::Ice::Context& __ctx)
    {
        return begin_motorStates(mstateMap, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_motorStates(mstateMap, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_motorStates(mstateMap, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::RoboCompJointMotor::Callback_JointMotorPublish_motorStatesPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_motorStates(mstateMap, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::Ice::Context& __ctx, const ::RoboCompJointMotor::Callback_JointMotorPublish_motorStatesPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_motorStates(mstateMap, &__ctx, __del, __cookie);
    }
...
class JointMotorPublish : virtual public ::IceDelegate::Ice::Object
{
public:

    virtual void motorStates(const ::RoboCompJointMotor::MotorStateMap&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};
...
class JointMotorPublish : virtual public ::IceDelegate::RoboCompJointMotor::JointMotorPublish,
                          virtual public ::IceDelegateM::Ice::Object
{
public:

    virtual void motorStates(const ::RoboCompJointMotor::MotorStateMap&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};
