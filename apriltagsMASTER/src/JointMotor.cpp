...
void
IceProxy::RoboCompJointMotor::JointMotorPublish::motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::Ice::Context* __ctx)
{
    ::IceInternal::InvocationObserver __observer(this, __RoboCompJointMotor__JointMotorPublish__motorStates_name, __ctx);
    int __cnt = 0;
    while(true)
    {
        ::IceInternal::Handle< ::IceDelegate::Ice::Object> __delBase;
        ...
        {
            __delBase = __getDelegate(false);
            ::IceDelegate::RoboCompJointMotor::JointMotorPublish* __del = dynamic_cast< ::IceDelegate::RoboCompJointMotor::JointMotorPublish*>(__delBase.get());
            __del->motorStates(mstateMap, __ctx, __observer);
            return;
        }
        catch(const ::IceInternal::LocalExceptionWrapper& __ex)
        {
...
::Ice::AsyncResultPtr
IceProxy::RoboCompJointMotor::JointMotorPublish::begin_motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ...
    try
    {
        __result->__prepare(__RoboCompJointMotor__JointMotorPublish__motorStates_name, ::Ice::Normal, __ctx);
        ::IceInternal::BasicStream* __os = __result->__startWriteParams(::Ice::DefaultFormat);
...
::IceInternal::Handle< ::IceDelegateM::Ice::Object>
IceProxy::RoboCompJointMotor::JointMotorPublish::__createDelegateM()
{
    return ::IceInternal::Handle< ::IceDelegateM::Ice::Object>(new ::IceDelegateM::RoboCompJointMotor::JointMotorPublish);
}

::IceInternal::Handle< ::IceDelegateD::Ice::Object>
IceProxy::RoboCompJointMotor::JointMotorPublish::__createDelegateD()
{
    return ::IceInternal::Handle< ::IceDelegateD::Ice::Object>(new ::IceDelegateD::RoboCompJointMotor::JointMotorPublish);
}
...
void
IceDelegateM::RoboCompJointMotor::JointMotorPublish::motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
    ::IceInternal::Outgoing __og(__handler.get(), __RoboCompJointMotor__JointMotorPublish__motorStates_name, ::Ice::Normal, __context, __observer);
    try
    {
        ::IceInternal::BasicStream* __os = __og.startWriteParams(::Ice::DefaultFormat);
        __os->write(mstateMap);
...
void
IceDelegateD::RoboCompJointMotor::JointMotorPublish::motorStates(const ::RoboCompJointMotor::MotorStateMap& mstateMap, const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    class _DirectI : public ::IceInternal::Direct
    {
    public:

        _DirectI(const ::RoboCompJointMotor::MotorStateMap& __p_mstateMap, const ::Ice::Current& __current) : 
            ::IceInternal::Direct(__current),
            _m_mstateMap(__p_mstateMap)
        {
        }
        ...
        run(::Ice::Object* object)
        {
            ::RoboCompJointMotor::JointMotorPublish* servant = dynamic_cast< ::RoboCompJointMotor::JointMotorPublish*>(object);
            if(!servant)
            {
                throw ::Ice::OperationNotExistException(__FILE__, __LINE__, _current.id, _current.facet, _current.operation);
            }
            servant->motorStates(_m_mstateMap, _current);
            return ::Ice::DispatchOK;
        }
        
    private:
        
        const ::RoboCompJointMotor::MotorStateMap& _m_mstateMap;
    };
    
    ::Ice::Current __current;
    __initCurrent(__current, __RoboCompJointMotor__JointMotorPublish__motorStates_name, ::Ice::Normal, __context);
    try
    {
        _DirectI __direct(mstateMap, __current);
        try
...
RoboCompJointMotor::JointMotorPublish::___motorStates(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    __is->read(mstateMap);
    __inS.endReadParams();
    motorStates(mstateMap, __current);
    __inS.__writeEmptyParams();
    return ::Ice::DispatchOK;
}
